...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str,  default = '/home/yuhongtao/SOT-Data/VOT2018', help='dataset root directory')
    parser.add_argument('--dataset', type=str, default = 'VOT2018', help='dataset name')
    parser.add_argument('--tracker_result_dir', default='/home/yuhongtao/d3s/pytracking/tracking_result', type=str, help='tracker result root')
