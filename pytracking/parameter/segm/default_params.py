...
def parameters():
    ...
    params.segm_net_path = '/home/CMEDFL/pytracking/networks/checkpoints1/ltr/segm/segm_default/SegmNet_ep****.pth.tar'   #22
    ...
    "memory setting"
    params.obj_n = 1
    params.budgets = 160000   #160000
    params.update_rate = 0.001  #0.001
    params.merge_thr = 0.90   #0.90
    params.merge_thrdown = 0   #0.65
    params.remove = 0.005    #0.005
    device = torch.device('cuda', 0)
    params.device1 = device
    ################################################################
